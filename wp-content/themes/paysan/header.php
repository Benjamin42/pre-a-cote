...
<head profile="http://gmpg.org/xfn/11">
    <link href="<?php echo get_template_directory_uri(); ?>/img/logo-modif.png" rel="icon" />
...
<div class="container">
    ...
    <header>
        <div class="row">
            <div>
                <center>
                    <img style="margin-bottom: 10px; margin-top: 10px" width="150px" src="<?php echo get_template_directory_uri(); ?>/img/logo-modif.png"/>
                    <!--
            ...
            $defaults = array(
                ...
                'items_wrap'     => '
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="https://www.facebook.com/lepredacote/" target="_blank"><div class="icon-facebook"></div></a></li>
                    </ul>'
            );
